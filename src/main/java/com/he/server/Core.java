...
public class Core {
    ...
    private static final int warningRate = 80;
     ...
     * @throws Exception
     */
    public void checkSingle(String[] arr,int count)throws Exception {
        ...
        try (
            ...
            List<String> list = this.addInfoToList(arr,limitMemory,count);
     ...
     * @throws Exception
     */
    private List<String> addInfoToList(String[] arr,String limitMemory,int count)throws Exception {
